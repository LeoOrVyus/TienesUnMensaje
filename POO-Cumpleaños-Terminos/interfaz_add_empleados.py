...
def crear_empleado():
    ...
    fecha_nacimiento_str = fecha_nacimiento_cal.get()
    fecha_nacimiento_date = datetime.strptime(fecha_nacimiento_str, '%Y-%m-%d').date()
    fecha_de_nacimiento = datetime.combine(fecha_nacimiento_date, datetime.min.time())
    ...
    sql = "INSERT INTO empleados2 (nombre, correo, fecha_de_nacimiento, tipo_de_empleado) VALUES (%s, %s, %s, %s)"
